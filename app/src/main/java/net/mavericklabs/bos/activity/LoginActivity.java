    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChangeLanguage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (locale == null) {
                    locale = Constants.en_INLocale;
                }
                if (locale.equals(Constants.en_INLocale)) {
                    SharedPreferenceUtil.setStringPreference(getApplicationContext(), "locale", Constants.mr_INLocale);
                } else if (locale.equals(Constants.mr_INLocale)) {
                    SharedPreferenceUtil.setStringPreference(getApplicationContext(), "locale", Constants.en_INLocale);
                }
                setTranslations();
            }
        });
